...
import dns.core.*;
import dns.core.hosts.HostsFileParser;
...
public class LookupSession {
  ...
  public static class LookupSessionBuilder {
     ...
     * dns.core.lookup.LookupSession#DEFAULT_MAX_ITERATIONS}.
     *
     * @return {@code this}.
     */
     ...
     * absolute. The default is {@value dns.core.lookup.LookupSession#DEFAULT_NDOTS}, meaning
   ...
   *
   * <ul>
   *   <li>Resolver: an {@link dns.core.ExtendedResolver} initialized with the system's default
   *       DNS servers as determined by {@link dns.core.ResolverConfig}.
   *   <li>ndots: as determined by {@link dns.core.ResolverConfig}.
