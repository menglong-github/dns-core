...
public class Zone implements Serializable {
   ...
   *
   * @param zone The name of the zone.
   * @param inputStream The master file to read from.
   * @see Master
   */
  public Zone(Name zone, InputStream inputStream) throws IOException {
    data = new HashMap<>();

    if (zone == null) {
      throw new IllegalArgumentException("no zone name specified");
    }
    try (Master m = new Master(inputStream, zone)) {
      Record record;
