...
import dns.core.config.AndroidResolverConfigProvider;
import dns.core.config.FallbackPropertyResolverConfigProvider;
import dns.core.config.InitializationException;
import dns.core.config.JndiContextResolverConfigProvider;
import dns.core.config.PropertyResolverConfigProvider;
import dns.core.config.ResolvConfResolverConfigProvider;
import dns.core.config.ResolverConfigProvider;
import dns.core.config.SunJvmResolverConfigProvider;
import dns.core.config.WindowsResolverConfigProvider;
 ...
 *
 * <ul>
 *   <li>dnsjava properties, see {@link dns.core.config.PropertyResolverConfigProvider}
 *   <li>On Unix, /etc/resolv.conf is parsed, see {@link
 *       dns.core.config.ResolvConfResolverConfigProvider}
 *   <li>On Windows, GetAdaptersAddresses is called, see {@link
 *       dns.core.config.WindowsResolverConfigProvider}
 *   <li>On Android, system properties or the ConnectivityManager are read, see {@link
 *       dns.core.config.AndroidResolverConfigProvider}
 *   <li>The JNDI DNS Service Provider is queried, see {@link
 *       dns.core.config.JndiContextResolverConfigProvider}
 *   <li>The sun.net.dns.ResolverConfiguration class is queried, see {@link
 *       dns.core.config.SunJvmResolverConfigProvider}
